...
const command_1 = __nccwpck_require__(818);
const file_command_1 = __nccwpck_require__(710);
const utils_1 = __nccwpck_require__(846);
const os = __importStar(__nccwpck_require__(37));
const path = __importStar(__nccwpck_require__(17));
const oidc_utils_1 = __nccwpck_require__(230);
/**
...
const core_1 = __nccwpck_require__(40);
class OidcClient {
...
const pm = __nccwpck_require__(625);
let tunnel;
var HttpCodes;
(function (HttpCodes) {
...
class HttpClient {
    ...
    _getAgent(parsedUrl) {
        ...
        if (useProxy) {
            ...
            if (!tunnel) {
                tunnel = __nccwpck_require__(595);
            }
            const agentOptions = {
...
module.exports = __nccwpck_require__(301);
...
if (!globalThis.ReadableStream) {
  ...
  try {
    ...
    Object.assign(globalThis, __nccwpck_require__(3))
  }
}
...
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(945);
...
/* harmony import */ var _streams_cjs__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(180);
...
/* harmony export */ });
/* unused harmony export File */
/* harmony import */ var fetch_blob__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(945);
/* harmony import */ var fetch_blob_file_js__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(651);
...
var fetch_blob = __nccwpck_require__(945);
// EXTERNAL MODULE: ./node_modules/formdata-polyfill/esm.min.js
var esm_min = __nccwpck_require__(692);
...
class Body {
	...
	async formData() {
		...
		const {toFormData} = await __nccwpck_require__.e(/* import() */ 480).then(__nccwpck_require__.bind(__nccwpck_require__, 480));
...
const fetch = __nccwpck_require__(168)
